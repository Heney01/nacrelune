    ...
    return (
      <div className="container mx-auto text-center py-20">
        ...
        <Button asChild className="mt-4">
          <Link href={`/${params.locale}/login`}>Se connecter</Link>
        </Button>
      </div>
    );
  }
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="flex justify-start mb-8">
            <Button variant="ghost" asChild>
              <Link href={`/${params.locale}/creators/${firebaseUser.uid}`}>
              ...
              {orders.length === 0 ? (
                <div className="text-center py-16 border border-dashed rounded-lg">
                  ...
                  <Button asChild className="mt-6">
                    <Link href={`/${params.locale}`}>Commencer à créer</Link>
                  </Button>
                </div>
              ) : (
                       ...
                       <AccordionContent className="p-4 pt-0">
                           ...
                           <ul className="space-y-3">
                            ...
                            <Button asChild variant="outline" size="sm" className="mt-6 w-full">
                                <Link href={`/${params.locale}/orders/track?orderNumber=${order.orderNumber}`}>
